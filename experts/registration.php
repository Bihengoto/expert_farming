...
<head>
    ...
    <title>Expert Farmer Registration Form | LMS </title>
...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
            ...
            <section class="login_content" style="margin-top: -40px;">
                <form name="form1" action="" method="post">
                    <h2>Expert Farmer Registration Form</h2><br>
    ...
    <?php
        ...
        if(isset($_POST['submit1'])){
            ...
            $query = "INSERT INTO expert_registration (firstname, lastname, username, password, email, contact)         VALUES('$fname', '$lname', '$username', '$password', '$email', '$contact')";
