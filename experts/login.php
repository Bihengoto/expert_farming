...
<head>
    ...
    <title>Expert Farmer Login Form | LMS </title>
...
<?php
    ...
    if(isset($_POST['submit1'])){
        ...
        $query = "SELECT * FROM expert_registration WHERE username ='$user' AND password = '$pass'";
...
<?php
            ...
            $_SESSION['expert'] = $_POST['username'];
